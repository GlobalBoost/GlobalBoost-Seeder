...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "globalboost-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed.okerget.com", ""};
static const string testnet_seeds[] = {"testnet-seed.okerget.com", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 12368), true);
  }
  do {
